...
ggplot() + 
  ...
  geom_smooth(aes(y = number_of_delayed_bed_days, color = "#A61103")) +
  geom_line(aes(y = number_of_delayed_bed_days, colour = "#603BF2"))+
  geom_smooth(aes(y = number_of_delayed_bed_days, colour = "#603BF2")) +
  scale_y_sqrt() +
  scale_colour_manual(values = c("#A61103", "#603BF2"), labels = c("avg_daily","number of days")) +
